---
name : council
description : Spawn multiple agents to deeply explore a codebase area before acting
---
...
2. Spawn off n=3 (unless specified otherwise) task agents to dig deeper into the codebase in terms of that given area of interest, some of them should be out of the box for variance.
